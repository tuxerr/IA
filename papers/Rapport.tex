...
Les animaux ont tendance à rester en groupe, et ça de plusieurs faites. Le premier est du à leurs déplacement permanent.
Même si les moutons ne sont pas en état de non reproduction ils se deplace de temps en temps. Il en est de même pour le loup.
Ces déplacement se font aléatoirement avec autant de chance d'aller de tous les côtés. Il est donc normal qu'après une infinité de déplacement
ils ne bougent pas. Quand pour une raison quelconque ( par exemple à l'initialisation) ils ne sont pas en groupe la recherche de conjoint 
va faire en sorte de faire rejoindre les petits groupes d'animaux entre eux.\\
...
donc pas besoin de chercher leur nourriture.L'herbe se situe uniquement sur les plaines.
Ils ne peuvent pas manger deux fois au même endroit étant donné que l'herbe disparait 
aprés chaque consomation(devienne noir) et redevient normal après un petit lapse de temps. Ils n\\
...
Les moutons ne communique entre eux que pour savoir s'ils acceptent de se reproduire.
A chaque tour la jauge de nourriture diminue, mais ceci est loin d'être leur principal raison de décés.\\
